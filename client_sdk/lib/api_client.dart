...
class ApiClient {
  ApiClient({
    this.basePath = 'http://192.168.15.186:5105',
    this.authentication,
  });
  ...
  static dynamic fromJson(
    ...
    try {
      switch (targetType) {
        ...
        case 'AptSchedule':
          return AptSchedule.fromJson(value);
        case 'Business':
        ...
        case 'CreateAptSchedule':
          return CreateAptSchedule.fromJson(value);
        case 'Customer':
        ...
        case 'CustomerRecord':
          return CustomerRecord.fromJson(value);
        case 'FlowLoginRequest':
          return FlowLoginRequest.fromJson(value);
        case 'IdlePeriod':
