...
class BusinessApi {
  ...
  Future<Response<void>> apiV1BusinessDeactivatePatch({ 
    String? body,
    ...
    final _path = r'/api/v1/Business/deactivate';
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiV1BusinessDelete({ 
    String? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Business>> apiV1BusinessGet({ 
    String? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [Business] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Business>> apiV1BusinessPatch({ 
    Business? business,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      ...
      _bodyData = business == null ? null : _serializers.serialize(business, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [Business] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Business>> apiV1BusinessPost({ 
    ...
    try {
      const _type = FullType(BusinessRegisterRequest);
      _bodyData = businessRegisterRequest == null ? null : _serializers.serialize(businessRegisterRequest, specifiedType: _type);
