    ...
    public partial class initialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Services = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AllowListedServicesOnly = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    OpenOnHolidays = table.Column<bool>(type: "tinyint(1)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IdlePeriods", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IdlePeriods_AspNetUsers_BusinessId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Logs_AspNetUsers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessId = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    WasContacted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    dateTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    Service = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Description = table.Column<string>(type: "longtext", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessId = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    aptLogId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    dateTime = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Contacts_Logs_aptLogId",
                        column: x => x.aptLogId,
                        principalTable: "Logs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contacts_aptLogId",
                table: "Contacts",
                column: "aptLogId");

            migrationBuilder.CreateIndex(
                name: "IX_IdlePeriods_BusinessId",
                table: "IdlePeriods",
                column: "BusinessId");

            migrationBuilder.CreateIndex(
                name: "IX_IdlePeriods_Id",
                table: "IdlePeriods",
                column: "Id",
                unique: true);
