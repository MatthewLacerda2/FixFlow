...
public class FlowSeeder
{
    ...
    public async void PopulateDbIfEmpty()
    {
        ...
        if (!_context.Employees.Any())
        {
            ...
            var employees = Enumerable.Range(1, employeesCount).Select(_ => (EmployeeRegister)employeeSeed.Generate()).ToArray();
        ...
        if (!_context.Clients.Any())
        {
            ...
            var clients = Enumerable.Range(1, clientsCount).Select(_ => (ClientRegister)clientSeed.Generate()).ToArray();
