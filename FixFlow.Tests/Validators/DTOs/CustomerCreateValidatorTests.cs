...
public class CustomerCreateValidatorTests {
	...
	public void Should_Have_Error_When_FullName_Is_Invalid() {
		var model = new CustomerCreate("John", null, null, "1234567890", null);
	...
	public void Should_Not_Have_Error_When_FullName_Is_Valid() {
		var model = new CustomerCreate("John Doe", null, null, "1234567890", null);
		var result = _validator.TestValidate(model);
	...
	public void Should_Have_Error_When_CPF_Is_Invalid() {
		var model = new CustomerCreate("John Doe", "12345678900", null, "1234567890", null);
		var result = _validator.TestValidate(model);
	...
	public void Should_Not_Have_Error_When_CPF_Is_Valid() {
		var model = new CustomerCreate("John Doe", "123.456.789-09", null, "1234567890", null);
		var result = _validator.TestValidate(model);
