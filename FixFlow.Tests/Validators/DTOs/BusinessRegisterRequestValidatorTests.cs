...
namespace FixFlow.Tests.Validators.DTOs {
	public class BusinessRegisterRequestValidatorTests {
		...
		public void Should_Have_Error_When_ConfirmPassword_Does_Not_Match() {
			var model = new BusinessRegisterRequest("", "lenda@gmail.com", "789.4561.123/0001-80", "98999344788", "@Str0ng1", "@Str0ng2", "123456");
			var result = _validator.TestValidate(model);
		...
		public void Should_Not_Have_Error_When_ConfirmPassword_Matches() {
			var model = new BusinessRegisterRequest("", "lenda@gmail.com", "789.4561.123/0001-80", "98999344788", "@Str0ng!", "@Str0ng!", "123456");
			var result = _validator.TestValidate(model);
